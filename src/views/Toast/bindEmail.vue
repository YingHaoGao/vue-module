    ...
    <div class="toast">
        ...
        <el-dialog :visible.sync="state" @close="closeFn">
            ...
            <div class="jumpFeedback_body">
                <div class="user">
                    <input type="text" v-model="email"  placeholder="在此输入您的邮箱">
                    <img src="../../assets/images/login/del.png"  v-show="" alt="">
                </div>
                <div class="code">
                    <el-input v-model="code" placeholder="请输入验证码"></el-input>
                    <el-button type="primary" @click="getCode(email)">{{(isClickBtn? '重新发送'+time+'s' : '获取验证码')}}</el-button>
                </div>
      ...
      editSure() {
        if (this.code && this.email) {
          ...
          axios({
            headers: headers,
            method: 'put',
            url: '/realNet/customer/bindingEmail',
            data: params
          }).then(function (res) {
            var resObj = res.data
            if (resObj.code === 200){
