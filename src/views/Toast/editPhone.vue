    ...
    <div class="toast">
        ...
        <el-dialog :visible.sync="state" @close="closeFn">
            ...
            <div class="jumpFeedback_body" v-if="(active == 1)">
                <div class="user">
                    <input type="text" v-model="phoneEmail"  placeholder="在此输入原手机号">
            ...
            <div v-else class="jumpFeedback_body">
                <div class="user">
                    <input type="text" v-model="newEmail"  placeholder="在此输入新手机号">
                    <img src="../../assets/images/login/del.png"  v-show="" alt="">
                </div>
                <div class="code">
    ...
    methods: {
      nextStep() {
        ...
        if (this.phoneEmail && this.fCode ) {
          ...
          axios({
            method: 'put',
            url: '/realNet/customer/updatePhoneNum',
            headers: headers,
            data: params
          }).then(function (res) {
            var resObj = res.data
