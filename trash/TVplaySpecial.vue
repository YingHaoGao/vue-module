        ...
        return {
            loopPlayImagesData: {
                ...
                imagesData: [{
                        ...
                        backgroundImage: require('../assets/images/banner2.jpg'),
                        imgageLinkRouterName: '#'
                    }, {
                        backgroundImage: require('../assets/images/banner3.jpg'),
                        imgageLinkRouterName: '#'
                    }, {
                        backgroundImage: require('../assets/images/banner4.jpg'),
                        imgageLinkRouterName: '#'
                    }, {
                        backgroundImage: require('../assets/images/banner5.jpg'),
                        imgageLinkRouterName: '#'
                    }],
                defaultClasses: {
            ...
            if(data) {
                ...
                return {
                    ...
                    list: [{
                        ...
                        {
                            id: '232342',
                            img: require('../assets/images/vImage_2.jpg'),
                            name: '电影',
                            intro: '这是一部不错的电影',
                            grade: 8.8
                        },
                        {
                            id: '223423',
                            img: require('../assets/images/vImage_3.jpg'),
                            name: '电影',
                            intro: '这是一部不错的电影',
                            grade: 8.8
                        },
                        {
                            id: '323423',
                            img: require('../assets/images/vImage_4.jpg'),
                            name: '电影',
                            intro: '这是一部不错的电影',
                            grade: 8.8
                        },
                        {
                            id: '23223',
                            img: require('../assets/images/vImage_5.jpg'),
                            name: '电影',
                            intro: '这是一部不错的电影',
                            grade: 8.8
                        },
                        {
                            id: '233',
                            img: require('../assets/images/vImage_6.jpg'),
                            name: '电影',
                            intro: '这是一部不错的电影',
                            grade: 8.8
                        },
                        {
                            id: '23423',
                            img: require('../assets/images/vImage_7.jpg'),
                            name: '电影',
                            intro: '这是一部不错的电影',
                            grade: 8.8
                        },
